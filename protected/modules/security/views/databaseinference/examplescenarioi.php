...
<?php echo $ls->renderEditor($db, "SELECT * FROM EMPLOYEE;"); ?>

<p>Alice may know the average salary of all female employees with her current access level.</p>

<?php echo $ls->renderEditor($db, "SELECT AVG(salary) AS AVG_SALARY FROM EMPLOYEE WHERE GENDER='F';"); ?>
...
<?php echo $ls->renderEditor($db, "SELECT * FROM EMPLOYEE WHERE lastname='Goldberg'"); ?>
