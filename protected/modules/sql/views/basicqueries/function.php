...
<?php echo $this->getSqlEditor( "SELECT COUNT(score) FROM TEST_SCORES; -- How many tests were taken?"); ?>
<?php echo $this->getSqlEditor( "SELECT SUM(score) FROM TEST_SCORES; -- What is the total score of the tests taken?"); ?>
<?php echo $this->getSqlEditor( "SELECT AVG(score) FROM TEST_SCORES; -- What is the average sore of the tests taken?"); ?>
<?php echo $this->getSqlEditor( "SELECT MIN(score) FROM TEST_SCORES; -- What is the lowest score?"); ?>
<?php echo $this->getSqlEditor( "SELECT MAX(score) FROM TEST_SCORES; -- What is the highest score?"); ?>
