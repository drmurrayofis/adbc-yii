...
<?php echo $this->getSqlEditor( "-- What is the sum of all points earned by each student?
SELECT StudentID, SUM(score) FROM TEST_SCORES GROUP BY StudentID;"); ?>
<?php echo $this->getSqlEditor( "-- What is the average score earned by each student?
