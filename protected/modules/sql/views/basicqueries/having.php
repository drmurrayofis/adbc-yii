...
<?php echo $this->getSqlEditor(null, "-- Which tests have been taken exactly 3 times?
SELECT TestID, COUNT(score) FROM TEST_SCORES GROUP BY TestID HAVING COUNT(score)=3;"); ?>
<?php echo $this->getSqlEditor(null, "-- Out of the tests taken with an average score greater than 80, what is the lowest of each test's scores?
