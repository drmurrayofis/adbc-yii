        <h1>Animated DataBase Courseware Project</h1>
        <ul>
            <li><a href="#adbc_intro">Introduction to the ADBC Project</a></li>
            <li><a href="#adbc_goals">Goals for the ADBC Project</a></li>
            <li><a href="#nsf_funding">Gaining NSF funding for the project</a></li>
            <li><a href="#adbc_timeline">Timeline for the ADBC project</a></li>
            <li><a href="#about_ksu">About Kennesaw State Universtiy</a></li>
        </ul>
        
        <hr>

        <h2><a name="adbc_intro">Introduction to the ADBC Project</a></h2>
        <p>The Animated DataBase Courseware Project started as an online tool
        used to aid students at Kennesaw State University to learn the fundamentals
        of database concepts.</p>

        <h2><a name="adbc_goals">Project Objectives</a></h2>
        <h3>Expansion of current animation modules</h3>

        <p>This area focuses on further development and expansion of existing prototype animations.
        The current situation and proposed improvements for each of the modules is outlined below.</p>

        <h4>Database Design - Scenarios to E-R Diagrams</h4>
        <p>Converting Scenarios (problem specifications) to E-R diagrams is the weakest sub-module of the system
         ...
         as a Class Diagram as an alternative to E-R).</p>
        
        <p>Three of the new animation exercises will be developed from a Problem Specification, similar to our
        first three prototypes. The four other new exercises will be developed from a report format in an attempt to simulate a real world environment, where the system is
        ...
        <p>The SQL Module has been the most complete according to objective and subjective evaluations. However,
         ...
         developed for functions.</p>

        <p>In the lab environment, we observed that students demonstrated some common misconceptions regarding SQL.
        ...
        <figure>
        <img src="/images/documentation_fig_1.jpg" width="600" height="450">
        <figcaption>Figure 1. SQL Misconception - Multiply instead of Join</figcaption>
        </figure>
        ...
        <h3>Development of a Standard Interface</h3>
        <p>The current system has three different interfaces as a result of using three development environemnts:
        ...
        maintenance of the ADbC, it will be imortant to standardize all program development and the courseware interface.</p>

        <p>As 57 of the 73 animations were programmed in Java, we decided to use Java as the standard for all final products.
        ...
        support for the project will facilitate further maturation and development of the database courseware.</p>
        <h3>Additional Complex Topics (New Topics)</h3>
        ...
        as well as with Virtual Private Databases, Alternative methods of Encryption, and Database Auditing Procedures).</p>

        <h3>3.2 XML (eXtensible Markup Language)</h3>
        ...
        <h2>Gaining NSF funding for the project</h2>
        <p>The Animated DataBase Courseware Project started as an online tool used to aid students at Kennesaw State
        ...
        served as the proof-of-concept model for the submission to the National Science Foundation for project funding purposes.</p>
        
        <h2><a name="adbc_timeline">Timeline for the ADBC project</a></h2>
...
<!--Year 4-->   </td></tr><tr bgcolor="AAAAAA" align="center"><th colspan="2">Year Four
        ...
        *Second semester only
        ...
        <h2><a name="about_ksu">About Kennesaw State Universtiy</a></h2>
        <img border="0" src="/images/kh_vert.jpg" align="right" width="178" height="242">
        <p>Kennesaw State University (KSU), the third-largest university in the
            ...
            communities.</p>
        <p>Founded in 1963, Kennesaw State is located in Cobb County on a
            ...
            of its kind in northwest Georgia.</p>
            <p>
            ...
            U.S.News &amp; World Report three years in a row.</p>
            
            <p>The university is committing itself to expanding the global
            experience of students, faculty and staff through its
            <a href="https://sacs.kennesaw.edu">Quality Enhancement Plan</a>,
            known as the "Get Global" initiative. The QEP is part of KSU's continuing
            ...
            financial support for those who study abroad.</p>
            <p>Nearly 20,000 commuter and residential students, including more than
            ...
            20 percent of students are members of ethnic minorities.</p>
            <p>
            ...
            ratings in e-business and teamwork.</p>
            <p>
